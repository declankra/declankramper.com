...
export const timelineItems: TimelineItem[] = [
    ...
    },
    {
        ...
        description: "A fun personality-test app that reads your Strava activity titles and matches you with one of six distinct athlete personalities—from the “Data Enthusiast” to the “Storyteller”—unlocking a new way to analyze your activities and engage with the Strava community. Complete with custom-avatar generation and viral-sharing hooks.\n\nBorn from my observations (as a Strava DAU) that athletes pour their uniqueness into activity titles and my own use of commemorating my running thoughts into Strava posts, the app leans into Strava’s own push for custom titles to deepen social engagement—and, by extension, subscriber stickiness.\n\n**It’s my most complex build yet.** After three review cycles, Strava’s developer team rejected the project under a broad “no AI-model-training” clause that bans using Strava data for any model training—even though the app *never trains models*. It simply passes user-approved titles to OpenAI’s API, which *does not* train on customer data. Strava has not provided a more specific violation despite repeated requests, leaving the app blocked without a clear rationale. You can [view the demo here](https://www.loom.com/share/203fc26c1d5e407bb5a43ad64fbefae0?sid=7d7b2db6-4d7c-4adc-bc83-9ff44aca0a1c).",
